...
plink --make-bed --vcf eeu.filtered.pahse2.autosome0.01.vcf.gz --recode --out eeauto005 --allow-extra-chr --chr-set 30
awk '{x+=1}{print $1"\tSNP"x"\t"$3"\t"$4}' eeauto001.map > eeauto001new.map
